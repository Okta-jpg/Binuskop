...
const Register = () => {
    ...
    const Body = {
      background: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("https://getwallpapers.com/wallpaper/full/9/a/7/375257.jpg")',
    ...
    return (
        <Container fluid className="vh-100" style={Body}>
              ...
              <Card.Body className="p-5">
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <div className="text-center">
                    ...
                    <Button variant="link" onClick={() => navigate('/login')} className="p-0 ms-1" style={{ color: '#CBAE81' }}>
                      Login
                    </Button>
                  </div>
                </Form>
